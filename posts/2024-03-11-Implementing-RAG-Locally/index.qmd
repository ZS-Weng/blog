...
- Key components to RAG
- Fill in on details to the blog page
- Generate an image on the RAG process in steps
...
- Explain about embedding
- Find out how is the BERT transformers model trained
- 
