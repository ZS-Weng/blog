...
The most straightforward way to use RAG on your documents is with the NVIDIA tool chat with rtx which can be downloaded from the NVIDIA website and installed directly. 
